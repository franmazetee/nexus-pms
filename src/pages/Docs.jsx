...
export default function Docs() {
  return <ModulePage color="#FF3CAC" icon="◇" title="Documentação IA" desc="Documentação técnica gerada e mantida por IA para cada sistema." items={['Geração por IA','Arquitetura','Manual do Usuário','APIs & Integrações','Release Notes','Guia de Implantação']} />
}
